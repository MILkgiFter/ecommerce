...
def add_product():
    """
       ...
       responses:
         200:
           description: Страница с формой добавления продукта
       """
    if request.method == 'POST':
    ...
    """
        ...
        parameters:
          - name: product_id
            ...
            type: string
            required: true
            description: ID продукта для редактирования
          - name: name
            in: formData
            type: string
            required: true
          ...
          - name: category
            ...
            type: string
            required: true
            description: Новая категория продукта
          - name: image_url
            in: formData
            type: string
            required: true
        ...
        responses:
          200:
            description: Страница редактирования продукта
          302:
            description: Редирект к списку продуктов после обновления
        """
...
def delete_product(product_id):
    """
        ...
        responses:
          302:
            description: Редирект на страницу со списком продуктов
        """
...
def view_product(product_id):
    """
        ...
        responses:
          200:
            description: Детальная страница продукта
          302:
            description: Редирект на страницу авторизации, если пользователь не залогинен
          404:
